...
* Within the */dist/index.html* file, replace the following href values:
    * `assets/vendor.css` with `sl-ember-test-helpers/dist/assets/vendor.css`
    * `assets/dummy.css` with `sl-ember-test-helpers/dist/assets/dummy.css`
    * `assets/vendor.js` with `sl-ember-test-helpers/dist/assets/vendor.js`
    * `assets/dummy.js` with `sl-ember-test-helpers/dist/assets/dummy.js`
